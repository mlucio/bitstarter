...
var URLFILE_DEFAULT = "xfile.html";
...
var writeUrlFile = function(urlfile,checks) {
    var response2console = buildfn(urlfile,checks);
...
if(require.main == module) {
    ...
    if (program.url != URLFILE_DEFAULT) {
       writeUrlFile(program.url, program.checks);
